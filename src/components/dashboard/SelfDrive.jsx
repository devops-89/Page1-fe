  ...
  return (
    ...
    >
      ...
      <Box mb={4} textAlign="center">
        ...
        >
          Self Drive Booking Dashboard
        </Typography>
        <Typography
          variant="body1"
          sx={{ fontFamily: nunito.style, fontWeight: 400, color: COLORS.BLACK }}
        >
          View and manage all self-drive bookings with search and pagination controls.
        </Typography>
      </Box>
      ...
      >
        <Typography sx={{ fontFamily: nunito.style, fontWeight: 500 }}>
          ...
          {Math.min(currentPage * pageSize, filteredData.length)} of {filteredData.length} bookings
        </Typography>
