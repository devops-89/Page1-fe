        ...
        <Grid2 container sx={{ mt: 3 }} spacing={4} alignItems={"flex-start"}>
          ...
          <Grid2 size={3}>
            ...
            >
              {`${Math.floor(
                moment
                  .duration(flightDetails?.departure[0].Duration, "minutes")
                  .asHours()
              )} hrs ${moment
                .duration(flightDetails?.departure[0].Duration, "minutes")
                .minutes()} min`}
          ...
          <Grid2 size={3}>
            <Typography
              sx={{ fontSize: 22, fontWeight: 700, fontFamily: nunito.style }}
            >
              {moment(flightDetails?.departure[0].Destination.ArrTime).format(
                "HH:mm"
              )}
            </Typography>
            <Typography
            ...
            >
              ...
              {flightDetails?.departure[0].Destination.Airport.Terminal}{" "}
              Terminal
            </Typography>
            <Typography
              sx={{ fontSize: 14, fontWeight: 600, fontFamily: nunito.style }}
