      ...
      <Card sx={{ boxShadow: "0px 0px 3px 3px rgb(0,0,0,0.10)", p: 2, mb: 4 }}>
        <Grid2 container spacing={3}>
          ...
          <Grid2 size={{ lg: 6, xs: 12 }}>
            ...
            <Grid2
              container
              sx={{ mt: 3, p: 1, backgroundColor: COLORS.SEMIGREY }}
              spacing={4}
            ...
            >
              <Grid2 size={4}>
                ...
                >
                  ...
                  {flightDetails?.departure[0]?.Origin?.Airport?.Terminal}{" "}
                  Terminal
                </Typography>
                <Typography
                  sx={{
                ...
                <Divider sx={{ borderColor: COLORS.BLACK, mt: 1 }}>
                  <Avatar
                    sx={{
                      ...
                      width: { lg: "40px", md: "40px", sm: "24px", xs: "24px" },
                      height: {
                        lg: "40px",
                        md: "40px",
                        sm: "24px",
            ...
            >
              ...
              >
                ...
                >
                  Only {flightDetails?.departure[0]?.NoOfSeatAvailable} seats
                  left
                </Typography>
                <Button
                  sx={{
                  ...
                  endIcon={
                    openLeft ? <KeyboardArrowUp /> : <KeyboardArrowDown />
                  }
            ...
            >
              <Grid2 size={4}>
                ...
                >
                  ...
                  {flightDetails?.arrival[0]?.Origin?.Airport?.Terminal}{" "}
                  Terminal
                </Typography>
                <Typography
                  sx={{
              ...
              <Grid2 size={4}>
                ...
                >
                  {`${Math.floor(
                    ...
                    .duration(
                      flightDetails?.arrival[flightDetails?.arrival.length - 1]
                        ?.AccumulatedDuration,
                      "minutes"
                    )
                    .minutes()} min`}
            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  endIcon={
                    openRight ? <KeyboardArrowUp /> : <KeyboardArrowDown />
                  }
