    ...
    >
      <SwiperSlide>
        <Box sx={{ border: `1px solid ${COLORS.PRIMARY}`,p:2,height:"140px",borderRadius:2}}>
          <Typography variant="h5" sx={{textAlign:"center",fontWeight:"bold",color:COLORS.PRIMARY,fontFamily:roboto.style}}>Booking Offer</Typography>
          <Typography variant="body1" sx={{fontFamily:roboto.style,textAlign:"center"}}>
            {" "}
      ...
      <SwiperSlide>
        <Box sx={{ border: `1px solid ${COLORS.PRIMARY}`,p:2,height:"140px",borderRadius:2 }}>
          <Typography variant="h5" sx={{textAlign:"center",fontWeight:"bold",color:COLORS.PRIMARY,fontFamily:roboto.style}}>Baggage Transport</Typography>
          <Typography variant="body1"  sx={{fontFamily:roboto.style,textAlign:"center"}}>
            {" "}
      ...
      <SwiperSlide>
        <Box sx={{ border: `1px solid ${COLORS.PRIMARY}`,p:2,height:"140px",borderRadius:2 }}>
          <Typography variant="h5" sx={{textAlign:"center",fontWeight:"bold",color:COLORS.PRIMARY,fontFamily:roboto.style}}>Airport Transfer</Typography>
          <Typography variant="body1"  sx={{fontFamily:roboto.style,textAlign:"center"}}>
      ...
      <SwiperSlide>
        <Box sx={{ border: `1px solid ${COLORS.PRIMARY}`,p:2,height:"140px",borderRadius:2 }}>
          <Typography variant="h5" sx={{textAlign:"center",fontWeight:"bold",color:COLORS.PRIMARY,fontFamily:roboto.style}}>City Transfer</Typography>
          <Typography variant="body1"  sx={{fontFamily:roboto.style,textAlign:"center"}}>
