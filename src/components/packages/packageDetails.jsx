...
import {
  Box, Typography, Breadcrumbs, Link, Button, Grid, Card, CardMedia,
  Paper
} from '@mui/material';
    ...
    <Grid container spacing={4} sx={{ padding: { xs: 2, md: 4 } }}>
      ...
      <Grid item xs={12} lg={8}>
        <Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
          ...
          {/* Breadcrumb */}
          <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2, fontFamily: roboto.style }}>
            <Link underline="hover" color="inherit" href="/">Home</Link>
            <Link underline="hover" color="inherit" href="/packages">Packages</Link>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap={1}>
            <Typography variant="h4" fontWeight={600} sx={{ fontFamily: roboto.style }}>
              {data?.package_name}
            </Typography>
            <Box textAlign="right">
              ...
              <Typography variant="caption" color="text.secondary" sx={{ fontFamily: roboto.style }}>
          ...
          <Paper elevation={1} sx={{ p: 2, mt: 3, borderRadius: 2, backgroundColor: '#f9f9f9' }}>
  <Box sx={{ fontFamily: roboto.style }}>
    ...
    <Box display="flex" alignItems="center" gap={1} mb={1}>
      ...
      <Typography variant="body2">
        <strong>Destination:</strong> {data?.package_destination || "N/A"}
      </Typography>
    </Box>
    ...
    <Box display="flex" alignItems="flex-start" gap={1} mb={1}>
      ...
      <Typography variant="body2">
        ...
        {data?.country || ""}
          ...
          {/* Overview */}
          <Typography variant="h6" sx={{ mt: 4, mb: 1, fontFamily: roboto.style }}>
          ...
          {/* Gallery */}
          <Typography variant="h6" sx={{ mt: 5, mb: 2, fontFamily: roboto.style }}>
            Gallery
          </Typography>
        ...
        <Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
          <Box sx={{ fontFamily: roboto.style }}>
            ...
            <Box display="flex" alignItems="center" gap={1} mb={1}>
              ...
              <Typography variant="body2"><strong>Package Type:</strong> {data?.package_type || 'N/A'}</Typography>
            </Box>

            <Box display="flex" alignItems="center" gap={1}>
              <StarIcon fontSize="small" />
              <Typography variant="body2"><strong>Highlight:</strong> {data?.highlight || 'N/A'}</Typography>
            </Box>
          </Box>
        </Paper>
      </Grid>
