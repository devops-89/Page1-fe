...
const FlightDetails = ({ flightData, travelerData, fareSummary }) => {
  ...
  useEffect(()=>{
    ...
    flightController.flightDetails({
    ...
    >
      <Container>
        ...
        <Grid2 container spacing={2}>
            ...
            >
              ...
              >
                <Box>
                  ...
                  >
                    {data.flightDetails.flightData.origin} →{" "}
                    {data.flightDetails.flightData.destination}
                  </Typography>
                  <Box sx={{ display: "flex", gap: 2, marginTop: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ fontSize: 14 }}>
                      {data.flightDetails.flightData.stops} ·{" "}
                      {data.flightDetails.flightData.duration}
                    </Typography>
                  </Box>
                </Box>
          ...
          <Grid2 size={4}>
            <Paper
              sx={{ padding: 2, backgroundColor: "#F4F4F4", height: "300px" }}
            >
              <Typography
                variant="h6"
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <Typography variant="h6">
                  ₹{" "}
                  {data.flightDetails.fareSummary.reduce(
