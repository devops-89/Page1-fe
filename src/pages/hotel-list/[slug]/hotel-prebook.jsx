    ...
    <Grid2 container >
      ...
      <Container>
        <Grid2 container sx={{ my: 4, }} spacing={2}>
          {/* Left container */}
          <Grid2 size={{ xs: 12, md: 12, lg: 8 }} sx={{bgcolor:COLORS.WHITE}}>
            <Box >
                      ...
                      <Typography variant="subtitle2" sx={{ fontWeight: "bold" }} gutterBottom>
                        {
                          Array.from([0, 1, 2, 3, 4]).map((_, index) => (
                            <StarIcon key={index} sx={{ color: COLORS.PRIMARY }} />
                          ))
                        }
                      </Typography>
                      <Typography variant="subtitle2" gutterBottom>
                        Plot No 4, Sector 13, Next To Metro Station, Dwarka City Centre, Near Airport, Delhi, India
                      </Typography>
                    </Grid2>
                    <Grid2 size={{ xs: 12, md: 12, lg: 3 }}>
                      <img src="https://r1imghtlak.mmtcdn.com/de2824ba6a0211e8ab4a022fd3fb960a.jpg" alt="hotel_image" width={150} height={130} />
                    </Grid2>
                  </Grid2>
                </CardContent>
              </Card>
              ...
              <Card variant="outlined" sx={{boxShadow:1, mb: 3 }}>
                <CardContent>
                  <Grid2 container spacing={2} sx={{ alignItems: 'center' }}>
                    <Grid2 item size={{ xs: 12, md: 12, lg: 3 }} sx={{ textAlign: "center" }}>
                      <Typography>CHECK IN</Typography>
                      <Typography>23 Apr 2025</Typography>
                      <Typography>11 AM</Typography>
                    </Grid2>
                    <Grid2 item size={{ xs: 12, md: 12, lg: 2 }} sx={{ textAlign: "center" }}>
                      <Typography sx={{ border: `2px solid ${COLORS.PRIMARY}`, textAlign: "center", borderRadius: 5 }}>DAY USE</Typography>
                    </Grid2>
                    <Grid2 item size={{ xs: 12, md: 12, lg: 3 }} sx={{ textAlign: "center" }}>
                    ...
                    <Grid2 item size={{ xs: 12, md: 12, lg: 4 }} sx={{ textAlign: "center" }}>
...
{/* this section is used to show the additional information to be shown for the hotels */}
              <Card variant="outlined" sx={{boxShadow:1, mb: 3 }}>
                <CardContent>
                  <Typography variant="h6" sx={{ fontWeight: "bold" }}>Cancellation Policy</Typography>
              ...
              <Card variant="outlined" sx={{boxShadow:1}}>
                <CardContent>
                  <Typography variant='h6' sx={{ fontWeight: "bold" }}>Rate Conditions</Typography>
                  <List>
                    {hotel?.RateConditions.map((cond, idx) => (
                      <ListItem key={idx}>
                        <Typography dangerouslySetInnerHTML={{ __html: cond }} />
                      </ListItem>
                    ))}
                  </List>
                </CardContent>
          ...
          <Grid2 size={{ xs: 12, md: 12, lg: 4 }}>
            <Card variant="outlined" sx={{ boxShadow:1, p: 1,borderRadius:0 }}>
              <CardContent>
