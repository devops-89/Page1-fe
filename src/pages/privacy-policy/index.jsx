    ...
    <>
      ...
      <Container sx={{ py: { xs: 4, sm: 6, md: 8 } }}>
        <Typography variant="body1" sx={{ fontFamily: roboto.style }}>
          ...
          infringed.
          <br /> <br />
          (2) Identification of the copyrighted work claimed to have been (2)
          ...
          infringed upon.
          <br /> <br />
          (7) Identification of the material that has been removed or disabled
          and the location at which the material appeared before it was removed
          or disabled.
          <br /> <br />
          (8) A statement that you consent to the jurisdiction of the court in
          which your address is located, or if your address is outside India,
          for any judicial district in which we are located.
          <br /> <br />
          (9) A statement that you will accept service of process from the party
          that filed the Notification or the party’s agent.
          <br /> <br />
          (10) your name, address, and telephone number.
          <br /> <br />
          (11) A statement under penalty of perjury that you have a good faith
